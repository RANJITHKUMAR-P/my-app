...
import { AddRoomServiceListener } from '../../../../../services/foodAndBeverageTwo'
...
const RealtimeRoomServiceTwo = ({
  ...
  console.log(filteredRoomService, 'filteredRoomService')
...
export default RealtimeRoomServiceTwo
